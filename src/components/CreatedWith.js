...
const CreatedWith = ({ className = "" }) => {
  return (
    ...
    >
      <h1 className="m-0 w-[547px] relative text-inherit leading-[48px] capitalize font-bold font-inherit inline-block max-w-full z-[1] mq1050:text-19xl mq1050:leading-[38px] mq450:text-10xl mq450:leading-[29px]">
      ...
      <div className="h-[719.5px] w-[566.5px] absolute !m-[0] bottom-[-403.5px] left-[-175px]">
        <img
          ...
          src="/group-35905.svg"
        />
        <button className="cursor-pointer [border:none] pt-3.5 pb-[14.4px] pr-[21px] pl-[22px] bg-white absolute top-[100px] left-[252px] rounded w-52 flex flex-row items-start justify-start box-border gap-[12px] z-[1]">
